...
//Конструкторы 
Smartphone::Smartphone() : battery(54)
{
    cout << "\nПо умолчанию.\n";
...
// 1) >
bool Smartphone::operator >(Smartphone& another)
{
    return(this->memory > another.memory);
}
// 2) <
bool Smartphone::operator <(Smartphone& another)
{
...
//5) >> (cin)
istream& operator >>(istream& is, Smartphone& phone)
{
    cout << "\nСколько памяти в телефоне -> ";
    is >> phone.memory;
    return is;
}
...
{
    cout << "\nПамяти на телефоне: " << phone.memory << " GB";
    return os;
}
